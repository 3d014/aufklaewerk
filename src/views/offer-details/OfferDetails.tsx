        ...
        <Grid item container direction={"row"} sx={ { marginTop: "0" }}>
            <Grid item xs={6} sx={{ textAlign: "left"}}>
                ...
                <Grid container direction={"row"}>
                    <Grid item container direction={"column"} xs={6} sx={{ height: "130px"}}  alignItems="flex-start"  justifyContent="space-around">
                        <Grid item>
                            <div style={{
                                display: 'flex',
                                alignItems: 'center',
                ...
                <Grid container direction={"row"}>
                    <Grid item container xs={6} direction={"column"} alignItems="flex-start" >
                        <Grid item>
                            <h6 style={{ marginBottom: "10px", marginTop: "30px"}}>
                                Themenbereiche
                            </h6>
                            {
