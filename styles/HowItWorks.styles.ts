...
export const classes:Classes={
    smallerScreen:{
        ...
        title:{fontSize:'1.6em',color:"#ff5100",padding:'30px 0px 0px 20px',margin:'0px 0px 20px 0px',textAlign:'left'},
    ...
    sixStepsOuterBox:{backgroundColor:'#f0956a',paddingTop:'10px',borderRadius:'15px',width:'100%',textAlign:'left'},
    ...
    endingQuestionBox:{marginTop:'100px',backgroundColor:"#ff5100",borderRadius:'5% 95% 100% 0/50% 100% 0 50%',
    paddingTop:'15px',paddingLeft:'5%',paddingBottom:'20px',display:"flex",flexDirection:'column',alignItems:'start',
    color:'white'},
